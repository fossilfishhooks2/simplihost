...
std::atomic<bool> PORT_BUSY = false;
...
void handleClient(SOCKET clientSocket) {
   ...
   // auto startTime = std::chrono::high_resolution_clock::now();
    ...
    while (PORT_BUSY == true) {
        ...
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\bWaiting for port...");
...
int main(int argc, char* argv[]) {
    if (argc == 2) {
        if (strcmp(argv[1], "help") == 0) {
            printf("Simplihost 4.3.1 starting...\n");
            printf("Simplihost is a simple and lightweight web server. Like all HTTP websites, it hosts on port 80 by default. The default pessimistic transfer time is 2000 ms.\n");
            return 0;
        }
